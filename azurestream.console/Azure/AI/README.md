...
Link to - [Example Code](https://docs.microsoft.com/en-us/azure/cognitive-services/text-analytics/quickstarts/client-libraries-rest-api?tabs=version-3-1&pivots=programming-language-csharp)

This article shows you how to detect language, analyze sentiment, extract key phrases and entities using the [Text Analytics APIs](https://go.microsoft.com/fwlink/?LinkID=759711) with C#. The code was written to work on a .Net Core application, with minimal references to external libraries, so you could also run it on Linux or MacOS.

Refer to the [API definitions](https://go.microsoft.com/fwlink/?LinkID=759346) for technical documentation for the APIs.
...
## Running the project
1. Open the AZURESTREAM.sln file in Visual Studio 2019.
